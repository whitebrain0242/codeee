...
bool MySqlDatabase::is_friend_blocked(
...
bool MySqlDatabase::add_friend_block(
    const std::string& blocker,
    const std::string& blocked,
    bool& created,
    std::string& error
    ...
    static constexpr const char* sql =
        "INSERT IGNORE INTO friend_blocks("
        "blocker_username,"
        "blocked_username"
        ") VALUES(?,?)";
...
bool MySqlDatabase::remove_friend_block(
    const std::string& blocker,
    const std::string& blocked,
    bool& removed,
    std::string& error
...
bool MySqlDatabase::list_blocked_friends(
    const std::string& blocker,
